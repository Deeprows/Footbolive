...
/* =========================================================
   MOBILE FIXED TICKER POSITION
   Keep ticker directly below player footer
   ========================================================= */
...
(function () {
  ...
  function updateTickerPosition() {
    ...
    const rect =
      screenBottom.getBoundingClientRect();


    /*
     * Keep ticker directly below
     * the player footer.
     */
